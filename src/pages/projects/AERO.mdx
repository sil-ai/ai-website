...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
    <Button 
        label="TRY AERO" 
        target="_blank" 
        link="https://aero.multilingualai.com" 
        style={{ 
            marginTop: '10px',
            marginBottom: '10px'
        }}
...
<ul>
    ...
    <li>
        ...
        <p class='primary-dark'><i>
            ...
            in <u><a href="/projects/alpha2" target="_blank">Alpha2</a></u> for 
...
<div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
  <img src="/img/AI_workflows_brighter.drawio(1).png" alt="AI workflows chart" style={{ width: '80%', marginBottom: '10px' }} />
</div>

<p class="caption">
    An example layout of how AERO tools might connect to OBT processes for different expressions of orality
</p>
