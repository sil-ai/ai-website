...
based on previously translated Scripture. When a project contains about 8000 verses across multiple genres - equivalent to a complete New Testament -
...
Paratext Data from September 2024 to September 2025 indicates that projects using Scripture Forge draft generation were able to draft and review an average of 1,000 more verses than projects that did not use Scripture Forge. Watch this video for more details:

<div style={{textAlign: 'center'}}>
  <iframe width="560" height="315" src="https://www.youtube.com/embed/UItCFA530Fg" 
...
- Fully supports audio for Scripture checking, including highlighting each verse as it is read aloud.
- Offline functionality allows team members to work offline, with their changes seamlessly saved once an internet connection is re-established.

## Future Development
Scripture Forge will continue to offer new tooling to support multiple translation workflows 
and research-based draft generation processes for early translation projects that don’t yet have the minimum recommended translation data.
